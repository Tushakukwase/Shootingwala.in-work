...
import { LayoutDashboard, ImageIcon, Calendar, Star, TrendingUp, User, BookOpen, Tag, MapPin, FileText, Camera } from "lucide-react"
...
export default function Sidebar({ currentPage, onPageChange }: SidebarProps) {
  const menuItems = [
    ...
    { id: "portfolio", label: "Portfolio & KYC", icon: ImageIcon },
    ...
    { id: "stories", label: "Stories & Gallery", icon: FileText },
